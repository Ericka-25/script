...
-- Creación de la tabla Flight_Category (Categoría de Vuelo)
...
BEGIN
    CREATE TABLE Seat (
        ...
        FOREIGN KEY (IdCategory) REFERENCES Flight_Category(IdCategory) ON DELETE SET NULL
    );
